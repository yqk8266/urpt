...
<script>
  import { getFirstDayOfMonth, getDayCountOfMonth, getWeekNumber, getStartDateOfMonth, prevDate, nextDate, isDate, clearTime as _clearTime} from 'urpt-ui/src/utils/date-util';
  import Locale from 'urpt-ui/src/mixins/locale';
  import { arrayFindIndex, arrayFind, coerceTruthyValueToArray } from 'urpt-ui/src/utils/util';
  ...
  // remove the first urpt that satisfies `pred` from arr
