...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'urpt-ui/src/utils/date-util';
  import { hasClass } from 'urpt-ui/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'urpt-ui/src/utils/util';
