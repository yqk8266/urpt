...
demoConfig.entry = {
  background: path.join(process.cwd(), './demos/extension/src/background'),
  entry: path.join(process.cwd(), './demos/extension/src/entry')
};
demoConfig.output = {
  path: path.join(process.cwd(), './demos/extension/dist'),
  filename: '[name].js'
};
demoConfig.plugins = [
